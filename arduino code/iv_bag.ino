...
void loop() 
{
 values1 = getSensor1Data();                                    // LDR sensor Fetches light level from the LDR
 values2= getSensor2Data() ;                                    // ultrasonic sensor Fetches the distance as measured by the ultrasonic sensor
